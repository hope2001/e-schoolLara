    ...
    <header class="geex-header">
        <div class="geex-header__wrapper">
            <div class="geex-header__logo-wrapper">
                <a href="" class="geex-header__logo">
                    {{-- <a href="{{ route('admin.home') }}" class="geex-header__logo"> --}}
                    ...
                    <li class="geex-header__menu__item has-children">
                        ...
                        <ul class="geex-header__submenu">
                            <li class="geex-header__menu__item">
                                <a href="/" class="geex-header__menu__link">Server Management</a>
                            </li>
                            <li class="geex-header__menu__item">
                                <a href="/" class="geex-header__menu__link">Banking</a>
                            </li>
                            <li class="geex-header__menu__item">
                                <a href="index-4.html" class="geex-header__menu__link">Crypto</a>
                            </li>
                            <li class="geex-header__menu__item">
                                <a href="index-5.html" class="geex-header__menu__link">Invoicing</a>
                            </li>
                        </ul>
                    </li>
                ...
                <nav class="geex-sidebar__menu-wrapper">
                    <ul class="geex-sidebar__menu">
                        <li class="geex-sidebar__menu__item has-children">
                            ...
                            <ul class="geex-sidebar__submenu">
                                <li class="geex-sidebar__menu__item">
                                    <a href="index-2.html" class="geex-sidebar__menu__link">Server Management</a>
                                </li>
                                <li class="geex-sidebar__menu__item">
                                    <a href="index-3.html" class="geex-sidebar__menu__link">Banking</a>
                                </li>
                                <li class="geex-sidebar__menu__item">
                                    <a href="index-4.html" class="geex-sidebar__menu__link">Crypto</a>
                                </li>
                                <li class="geex-sidebar__menu__item">
                                    <a href="index-5.html" class="geex-sidebar__menu__link">Invoicing</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="geex-sidebar__menu__item has-children">
                            ...
                            <ul class="geex-sidebar__submenu">
                                <li class="geex-sidebar__menu__item">
                                    <a href="#" class="geex-sidebar__menu__link geex-customizer__btn--top">Top
                                        Menu</a>
                                </li>
                                <li class="geex-sidebar__menu__item">
                                    <a href="#" class="geex-sidebar__menu__link geex-customizer__btn--side">Side
                                        Menu</a>
                                </li>
                                <li class="geex-sidebar__menu__item">
                                    <a href="#"
                                        class="geex-sidebar__menu__link geex-customizer__btn--light">Light Demo</a>
                                </li>
                                <li class="geex-sidebar__menu__item">
                                    <a href="#" class="geex-sidebar__menu__link geex-customizer__btn--dark">Dark
                                        Demo</a>
                                </li>
                                <li class="geex-sidebar__menu__item">
                                    <a href="#" class="geex-sidebar__menu__link geex-customizer__btn--ltr">LTR
                                        Demo</a>
                                </li>
                                <li class="geex-sidebar__menu__item">
                                    <a href="#" class="geex-sidebar__menu__link geex-customizer__btn--rtl">RTL
                                        Demo</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="geex-sidebar__menu__item has-children">
                            ...
                            <ul class="geex-sidebar__submenu">
                                ...
                                <li class="geex-sidebar__menu__item">
                                    <a href="forgot-password.html" class="geex-sidebar__menu__link">Forget
                                        Password</a>
                                </li>
                                <li class="geex-sidebar__menu__item">
                                    <a href="verification.html" class="geex-sidebar__menu__link">Two Step
                                        Verification</a>
                                </li>
                                <li class="geex-sidebar__menu__item">
